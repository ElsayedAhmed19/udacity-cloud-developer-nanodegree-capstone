...
* `CreateStudent` - should create a new Student for a current user. A shape of data send by a client application to this function can be found in the `CreateStudentRequest.ts` file
